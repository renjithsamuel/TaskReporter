...
exports.getUniqueCategoryById = async (req,res,next) => {
    ...
    try{
        ...
        const CategoriesData = await categories.findById(CategoryID).populate('colaborators').populate('tasks');
...
exports.postCategory = async (req,res,next) => {
    if(req.body.categoryName == null || req.body.description == null || req.body.startDate == null || req.body.endDate == null ||  req.body.colaborators == null ||  req.body.tasks == null){
        return res.status(404).json({
            success : false,
...
exports.patchCategoryById = async (req,res,next) => {
    ...
    const patchableData = {
        ...
        tasks : req.body.tasks || CategoryData.tasks,
    }
    try{
